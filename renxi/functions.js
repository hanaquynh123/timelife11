...
function timeElapse(date){
	// var current = Date();
	// // var years=Math.floor(days / (3600 * 24));
	...
	// 	seconds = "0" + seconds;
	// }
	// var result = "Đã <span class=\"digit\">" + days + "</span> Ngày <span class=\"digit\">" + hours + "</span> Giờ <span class=\"digit\">" + minutes + "</span> Phút <span class=\"digit\">" + seconds + "</span> Giây"; 
	// $("#clock").html(result);
	...
	+ hours + "</span> giờ <span class=\"digit\">   <br>" 
